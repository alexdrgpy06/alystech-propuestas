  ...
  return (
    <div className="w-full flex flex-col gap-6 py-4">
      ...
      >
        ...
        <h1 className="font-headline-md md:font-display-lg text-headline-md md:text-display-lg text-on-surface mb-2 md:mb-4">
          {content.title}
        </h1>
      ...
      >
        {/* Risk Card */}
        <GlassPanel variant="light" className="p-4 md:p-6">
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg bg-danger/10 flex items-center justify-center text-danger flex-shrink-0">
            ...
            <div>
              ...
              <p className="text-body-medium md:text-body-base text-ink-secondary leading-relaxed">
                {content.risk}
              </p>
            </div>
          </div>
        ...
        {content.impact && (
          <GlassPanel variant="light" className="p-4 md:p-6">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg bg-warning/10 flex items-center justify-center text-warning flex-shrink-0">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        {content.guarantee && (
          <GlassPanel variant="light" className="p-4 md:p-6 md:col-span-2">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg bg-positive/10 flex items-center justify-center text-positive flex-shrink-0">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        {content.engineeringNote && (
          <GlassPanel variant="light" className="p-4 md:p-6 md:col-span-2 bg-amber-soft/50 border-amber/20">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg bg-amber/10 flex items-center justify-center text-amber flex-shrink-0">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
